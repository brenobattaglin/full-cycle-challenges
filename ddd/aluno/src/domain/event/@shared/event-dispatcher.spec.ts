...
import LogConsoleWhenCustomerAddressIsChangedHandler from "../customer/handler/log-console-when-customer-address-is-changed";
import LogConsoleWhenCustomerIsCreatedHandler from "../customer/handler/log-console-when-customer-is-created";
import LogSecondConsoleWhenCustomerIsCreatedHandler from "../customer/handler/log-second-console-when-customer-is-created";
